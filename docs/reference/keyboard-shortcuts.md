...
| Shortcut | Action |
|---|---|
| `g` then `d` | Go to your personal **D**ashboard. |
| `g` then `p` | Go to your **P**rojects list. |
| `g` then `o` | Go to your **O**rchestrators. |
| `g` then `f` | Go to the **F**orum. |
| `g` then `n` | Go to **N**otifications. |
...
| Shortcut | Action |
|---|---|
| `c` | **C**ompose new topic (from a board page). |
| `r` | **R**eply (from a thread page, with a post focused). |
...
See the **[OpenPLC Editor docs](../openplc-editor/overview)** for the full list and language-specific shortcuts.
