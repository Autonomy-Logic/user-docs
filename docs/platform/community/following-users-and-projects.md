...
See **[Pinning and stars](../projects/pinning-and-stars)** for the full breakdown. Quick recap:
...
- **They do not start a DM channel.** Direct messaging is opt-in via the forum's messaging UI; see **[Messaging](../forum/messaging)**.
- **They do not auto-subscribe you to forum replies.** Forum subscriptions are per-thread, not per-user.

## Where to next

- **Manage your own follower list** → **[Your user profile](../../account/user-profile)**.
- **Star your favorites** → **[Pinning and stars](../projects/pinning-and-stars)**.
- **Open a DM with someone you follow** → their profile → **Message** button → **[Messaging](../forum/messaging)**.
