...
1. Reserves a unique Device entity in the cloud with the name and ID you give it.
...
- **Install the agent on a device** → **[Installing the Device Agent](installing-the-agent)**.
- **See your Devices in the web app** → **[Devices list](devices-list)**.
- **Inspect a single Device** → **[Device detail](device-detail)**.
- **Rename, delete, or replace a Device** → **[Managing devices](managing-devices)**.
- **Add a vPLC to a Device** → **[Creating a vPLC](../vplcs/creating-a-vplc)**.
