...
vPLCs are created inside a Device. The flow is:

1. Open the Device that should host the new vPLC.
2. Click **+ New vPLC**.
3. Walk through the three-step New vPLC wizard.

## Step 1, Open the wizard

From the **[Devices list](../devices/devices-list)**, click the Device card. You land on **[Device detail](../devices/device-detail)** with the **vPLCs** tab active.

The vPLCs tab shows your existing vPLCs as cards, plus a dashed **+ New vPLC** tile at the end of the grid. Click that tile.

## Step 2, Details

The wizard opens on a dedicated page. A 3-step indicator at the top shows the flow: **1. Details**, **2. Network**, **3. Serial Ports**.

![New vPLC wizard step 1, Details: vPLC Name field and Runtime Version dropdown, both empty](images/new-vplc-step1.png)
...
Click **Create vPLC** at the bottom right.
...
You should see the new vPLC card appear in the vPLCs tab within a few seconds, with status **Running** once the runtime is alive.
