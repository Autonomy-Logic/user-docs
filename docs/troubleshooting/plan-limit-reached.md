...
![Plan limit reached, Device limit reached (1/1) on plan Community](images/plan-limit-modal.png)
...
| Modal | Cause |
|---|---|
| *Device limit reached* | Trying to add a Device beyond your plan cap. Community allows 1. |
| *vPLC limit reached* | Trying to add a vPLC beyond the cap (across all your Devices). Community allows 2. |
...
- **Devices**: delete a Device you don't use. **[Managing devices](../platform/devices/managing-devices)**.
- **vPLCs**: delete vPLCs you're not running. 3-dot menu on the vPLC card → **Delete**.
