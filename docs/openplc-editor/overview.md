...
- Connect to a vPLC running on an **orchestrator**, deploy your build, and watch live variable values in the **debugger**.
...
- The **in-process simulator**: the editor connects to real vPLCs (or virtual ones running on an orchestrator), not to a browser-side AVR emulator.
