...
![Source Control panel showing the Changes, Stash and History tabs, the Changes tab with two modified files (main.ld and project.json) in a tree view grouped by folder, and the commit message textarea with Commit, Stash and Discard buttons at the bottom](../images/source-control-panel.png)
